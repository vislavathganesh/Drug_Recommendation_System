...
from drug_recommendation_system import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Drug_Recommendation_Type/$', remoteuser.Predict_Drug_Recommendation_Type, name="Predict_Drug_Recommendation_Type"),
    ...
    url(r'^View_Drug_Recommendation_Type_Ratio/$', serviceprovider.View_Drug_Recommendation_Type_Ratio, name="View_Drug_Recommendation_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Drug_RecommendationType/$', serviceprovider.View_Prediction_Of_Drug_RecommendationType, name="View_Prediction_Of_Drug_RecommendationType"),
